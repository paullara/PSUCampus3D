...
export default function BOA({ header, children }) {
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            >
                ...
                <nav className="flex flex-col gap-7 items-start p-9">
                    <NavLink
                        href={route("boa.achievements")}
                        active={route().current("boa.achievements")}
                    >
                        Achievements
                    </NavLink>
                    <NavLink
                        href={route("boa.announcement")}
                        active={route().current("boa.announcement")}
                    >
                        Announcement
                    </NavLink>
                    <NavLink
                        href={route("boa.services")}
                        active={route().current("boa.services")}
                    >
                        Services
                    </NavLink>
                    <NavLink
                        href={route("boa.happenings")}
                        active={route().current("boa.happenings")}
                    >
                        Happenings
                    </NavLink>
