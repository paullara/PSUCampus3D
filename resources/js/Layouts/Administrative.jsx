...
export default function Administrative({ header, children }) {
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            >
                ...
                <nav className="flex flex-col gap-7 items-start p-9">
                    ...
                    <NavLink
                        href={route("administrative.achievements")}
                        active={route().current("administrative.achievements")}
                    >
                        Achievements
                    </NavLink>
                    <NavLink
                        href={route("administrative.announcement")}
                        active={route().current("administrative.announcement")}
                    >
                        Announcement
                    </NavLink>
                    <NavLink
                        href={route("administrative.services")}
                        active={route().current("administrative.services")}
                    >
                        Services
                    </NavLink>
                    <NavLink
                        href={route("administrative.happenings")}
                        active={route().current("admin.happenings")}
                    >
                        Happenings
                    </NavLink>
                    <NavLink
                        href={route("administrative.postInfoBldg")}
                        active={route().current("administrative.postInfoBldg")}
                    >
                        Post Info
                    </NavLink>
