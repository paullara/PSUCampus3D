...
export default function CED({ header, children }) {
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            >
                ...
                <nav className="flex flex-col gap-7 items-start p-9">
                    <NavLink
                        href={route("ced.achievements")}
                        active={route().current("ced.achievements")}
                    >
                        Achievements
                    </NavLink>
                    <NavLink
                        href={route("ced.announcement")}
                        active={route().current("ced.announcement")}
                    >
                        Announcement
                    </NavLink>
                    <NavLink
                        href={route("ced.services")}
                        active={route().current("ced.services")}
                    >
                        Services
                    </NavLink>
                    <NavLink
                        href={route("ced.happenings")}
                        active={route().current("ced.happenings")}
                    >
                        Happenings
                    </NavLink>
