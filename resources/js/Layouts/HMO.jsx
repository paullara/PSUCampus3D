...
export default function HMO({ header, children }) {
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            >
                ...
                <nav className="flex flex-col gap-7 items-start p-9">
                    <NavLink
                        href={route("hmo.achievements")}
                        active={route().current("hmo.achievements")}
                    >
                        Achievements
                    </NavLink>
                    <NavLink
                        href={route("hmo.announcement")}
                        active={route().current("hmo.announcement")}
                    >
                        Announcement
                    </NavLink>
                    <NavLink
                        href={route("hmo.services")}
                        active={route().current("hmo.services")}
                    >
                        Services
                    </NavLink>
                    <NavLink
                        href={route("hmo.happenings")}
                        active={route().current("hmo.happenings")}
                    >
                        Happenings
                    </NavLink>
